...
export const puzzleGuides: PuzzleGuide[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { title: "Colors look identical?", text: "Players repeatedly flag pink vs red, white vs beige, purple vs dark blue, green vs yellow and brown vs purple as hard to tell apart — the last two surfaced in September 2026, and one player separately calls out beige-white vs grey-white. When two shades sit too close, a player workaround is to sort by the bottles' shapes instead of their colors. Before fighting the shelf, check the options menu — the developer's FAQ confirms colorblind support \"plus a lot more of accessibility options\", and the colorblind assist mode adds icons to the bottles — and zoom in (Ctrl on keyboard, right stick on controller; both developer-confirmed, and collected in our settings & comfort guide). Then lean on the chart, not your eyes, for the ambiguous pairs." },
    ...
    mistakes: [
      ...
      "Trusting your eyes on the pairs players report look nearly identical — pink/red, white/beige, purple/dark-blue, green/yellow and brown/purple.",
  ...
  },
  {
    ...
    steps: [
      ...
      { title: "What are the objects floating on and circling the bottles?", text: "Two kinds of objects ride along with potion bottles, and both are normal clue carriers rather than glitches (community answer, corroborated by a second player): objects floating in the liquid are raven feathers, and the gems or stones orbiting around a bottle are exactly what they look like. But if the orbiting gems render pitch black with no texture at all, that is a reported rendering issue, not a sign your puzzle logic is wrong — a player shared a screenshot of the problem on the Steam forum (22 Sep 2026) and diagnosed it as missing textures; the developer has not confirmed a cause yet, and standard first steps like restarting or verifying game files are unverified suggestions rather than confirmed fixes." },
