          ...
          <div className="article-body">
            ...
            <section id="checking" className="article-section">
              ...
              <ul className="mistake-list" style={{ listStyle: "none" }}>
                ...
                <li><strong>Hold Tab with a potion in hand.</strong> Boards you have not finished bring up their solution overlay; if nothing appears for a shelf, that shelf is already done. If holding it wears thin, the developer confirmed Tab can be <strong>switched to a toggle in the options menu</strong> — &quot;you can also toggle the Tab if you don&apos;t want to hold it in the options menu&quot; (5 Sep 2026). On controller the equivalent is <strong>up on the D-pad</strong> — it shows the solution reminder for the set you are holding (player-confirmed in a Steam tips thread, 3 Sep 2026).</li>
