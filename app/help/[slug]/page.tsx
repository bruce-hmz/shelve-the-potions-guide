          ...
          <div className="article-body">
            <section id="overview" className="article-section article-section--first">
              ...
              {isAchievements ? (
                ...
                <>
                  ...
                  <p>
                    Separate from the menu, keybind-triggered abilities (highlight, Assemble, reveal) unlock as you complete shelves — players report they can appear without much fanfare, which is why the patch v1.0.11 option to disable them entirely matters for achievement runs. The abilities sit on the default <strong>1-2-3</strong> keys, and the community&apos;s number-to-ability mapping (player-reported, not developer-confirmed) is: <strong>2 is Assemble</strong>, and <strong>3 is the shelf-checking ability that shows which shelves are still wrong</strong>. Which ability is on <strong>1</strong> has not been pinned down — highlight and reveal are the remaining two, and no source has yet confirmed their order.
                  </p>
            ...
            {isAchievements && (
              <>
                ...
                <section id="hooman" className="article-section article-callout article-callout--hint">
                  ...
                  <p>
                    And if the menu opens but offers <strong>only the solution option</strong> — no hint or highlight at all — the bottle in your hand belongs to a puzzle you have already solved. The developer confirmed the rule verbatim in the same thread (10 Sep 2026): &quot;You need to ask her with a potion that you didn&apos;t solve the puzzle for yet.&quot; Shelve the solved bottle and pick up one from a set you have not completed yet.
                  </p>
                  <p>
                  ...
                  <p>
                    One more warning: this achievement is effectively <strong>missable</strong>. If you have already solved every puzzle in the workshop, no unsolved board remains for the hint to act on — the player who shared the method notes you would have to wait for another playthrough, and a second player independently described the same wall on 10 Sep 2026: only after restarting a run with unsolved sets remaining did the achievement pop (player-reported). So if you are chasing all 24, use your first hint deliberately while puzzles are still open. Even completionists hit this wall from the other side: a 3 Sep 2026 review from a player who reached 100% in under seven hours without using a single skill says figuring out how to unlock <em>&quot;Hooman needs help :)&quot;</em> was the part that stumped them longest.
                  </p>
                  <p className="source-note">
                    Source: Steam discussions &quot;How do you unlock Hooman need help?&quot; (26–27 Aug 2026, accepted community answer plus a corroborating reply) and &quot;I can&apos;t ask cats for hints?&quot; (2–10 Sep 2026) — the 30-shelf rule and the solution-only rule (no hint option for an already-solved puzzle) are both developer-confirmed in the latter, via the accepted 3 Sep answer and the 10 Sep reply; the 50-shelf reveal threshold is inferred from the on-screen counters; the fresh-run account is player-reported. Remaining steps are community-verified, not retested by us in-game.
                  </p>
                </section>
              ...
              <>
                ...
                <section id="assemble" className="article-section">
                  ...
                  <ul className="mistake-list" style={{ listStyle: "none" }}>
                    ...
                    <li><strong>The potions are not already shelved.</strong> Assemble never retrieves bottles you have already placed — and per a player report, a bottle counts as placed <em>even if you shelved it in the wrong slot</em>, so a wrongly shelved bottle will not be pulled back to your hand.</li>
                  </ul>
                  <p>
            ...
            <section id="sources" className="article-section">
              ...
              <ul className="mistake-list" style={{ listStyle: "none" }}>
                ...
                <li>Number-to-ability mapping (2 = Assemble, 3 = shelf-check) and the shelved-even-if-wrong Assemble nuance: community answer in the Steam thread &quot;How does the second ability work?&quot; (22 Sep 2026, self-qualified by its author) plus a Steam review calling the shelf-check &quot;skill 3&quot; (18 Sep 2026) — player-reported; the developer has not confirmed the key order, and slot 1 remains unverified.</li>
                <li>Accidental-trigger reports and rebinding advice: Steam discussion thread &quot;I wish there to be a lock for abilities&quot;.</li>
                <li>&quot;Hooman needs help :)&quot; unlock steps: Steam discussion &quot;How do you unlock Hooman need help?&quot; (accepted community answer, 26–27 Aug 2026), with the Upgrade-tab / &quot;Mark puzzle pieces&quot; menu path from a 27 Aug reply in the same thread. The 30-shelf threshold is developer-confirmed: accepted developer answer in &quot;I can&apos;t ask cats for hints?&quot; (3 Sep 2026); the 50-shelf reveal threshold is inferred from that thread&apos;s X/50 counter. The solution-only rule — a solved puzzle&apos;s potion gets no hint option — is developer-confirmed in the same thread (10 Sep 2026); the fresh-run account from that day is player-reported.</li>
